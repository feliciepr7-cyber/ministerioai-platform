            ...
            {showForgotPassword ? (
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <a 
                    href="/auth/google"
                    className="w-full mt-4 bg-[#3c4043] hover:bg-[#2d2e30] text-white border-0 h-12 rounded-lg font-medium flex items-center justify-center text-decoration-none no-underline"
